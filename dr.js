...
if (hot == '161.97.123.66'){
    ...
    if(document.URL.indexOf('?content=slot')>0){
        $(document).ready(function(){
            ...
            $("meta[name='description']").attr('content', 'DoraSlot: judi online slot online dengan beragam game yang bisa dimainkan dari pragmatic play. Dengan fasilitas yang lengkap dan mudah membuat anda seperti sultan.');
        ...
        $(document).ready(function(){
            document.title = 'Doraslot: Togel, Casino, Slot Online | Indo Jaya';
            $("meta[name='description']").attr('content', 'Doraslot memberikan kepuasan dalam main togel online, casino, slot. Rasakan kesenangan dalam mendapatkan jackpot besar. Jaya terus Indonesia bersama Doraslot.');
